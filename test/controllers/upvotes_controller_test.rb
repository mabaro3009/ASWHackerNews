...
class UpvotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upvote" do
    assert_difference('Upvote.count') do
      post upvotes_url, params: { upvote: { post_id: @upvote.post_id, user_id: @upvote.user_id } }
    end
  ...
  test "should update upvote" do
    patch upvote_url(@upvote), params: { upvote: { post_id: @upvote.post_id, user_id: @upvote.user_id } }
